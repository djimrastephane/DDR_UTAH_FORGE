...
class SearchService:
    ...
    def __init__(self, repo_root: Path, model_path: Path) -> None:
        ...
        self.cross_encoder_load_failed: bool = False
        if ENABLE_CROSS_ENCODER_RERANK:
            try:
                ...
                self.cross_encoder_load_failed = True
    ...
    def search(
        ...
        return {
            ...
            "retrieval_config": {
                ...
                "cross_encoder_requested": bool(ENABLE_CROSS_ENCODER_RERANK),
                "enable_cross_encoder_rerank": bool(self.cross_encoder is not None),
                "cross_encoder_load_failed": bool(self.cross_encoder_load_failed),
