...
def is_section_anchor_line(line: str) -> bool:
    ...
    anchor_kw = {"REPORT", "ANALYSIS", "STATEMENT", "GOVERNANCE", "SUMMARY", "DATA", "NOTES", "MATERIAL", "VESSELS"}
...
def select_heading_candidates(lines_all: list[dict], page_p95_size: float) -> list[str]:
    # Only checks first 30 lines; headings appear near the top of a page.
