...
def llm_health() -> dict[str, Any]:
    """Probe the local Ollama endpoint without running inference."""
    ok, detail = search_service.local_llm.health_check()
    return {
        "ok": ok,
        "detail": detail,
        "enabled": search_service.local_llm.enabled,
        "model": search_service.local_llm.model,
        "base_url": search_service.local_llm.base_url,
    }
